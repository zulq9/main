...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_SONY + QUANTITY_DESC_SONY + SKU_DESC_SONY
                + IMAGE_DESC_SONY + TAG_DESC_GADGET, new AddCommand(expectedItem));

        // multiple names - last name accepted
        assertParseSuccess(parser, NAME_DESC_OPPO + NAME_DESC_SONY + QUANTITY_DESC_SONY + SKU_DESC_SONY
                + IMAGE_DESC_SONY + TAG_DESC_GADGET, new AddCommand(expectedItem));

        // multiple phones - last phone accepted
        assertParseSuccess(parser, NAME_DESC_SONY + QUANTITY_DESC_OPPO + QUANTITY_DESC_SONY + SKU_DESC_SONY
                + IMAGE_DESC_SONY + TAG_DESC_GADGET, new AddCommand(expectedItem));

        // multiple emails - last email accepted
        assertParseSuccess(parser, NAME_DESC_SONY + QUANTITY_DESC_SONY + SKU_DESC_OPPO + SKU_DESC_SONY
                + IMAGE_DESC_SONY + TAG_DESC_GADGET, new AddCommand(expectedItem));

        // multiple addresses - last inventory accepted
        assertParseSuccess(parser, NAME_DESC_SONY + QUANTITY_DESC_SONY + SKU_DESC_SONY + IMAGE_DESC_OPPO
                + IMAGE_DESC_SONY + TAG_DESC_GADGET, new AddCommand(expectedItem));

        // multiple tags - all accepted
        Item expectedItemMultipleTags = new ItemBuilder(SONY).withTags(VALID_TAG_GADGET, VALID_TAG_SMARTPHONE)
                .build();
        assertParseSuccess(parser, NAME_DESC_SONY + QUANTITY_DESC_SONY + SKU_DESC_SONY + IMAGE_DESC_SONY
                + TAG_DESC_SMARTPHONE + TAG_DESC_GADGET, new AddCommand(expectedItemMultipleTags));
    }
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_OPPO + QUANTITY_DESC_OPPO + SKU_DESC_OPPO + IMAGE_DESC_OPPO,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_NAME_SONY + QUANTITY_DESC_SONY + SKU_DESC_SONY + IMAGE_DESC_SONY,
                expectedMessage);

        // missing phone prefix
        assertParseFailure(parser, NAME_DESC_SONY + VALID_QUANTITY_SONY + SKU_DESC_SONY + IMAGE_DESC_SONY,
                expectedMessage);

        // missing email prefix
        assertParseFailure(parser, NAME_DESC_SONY + QUANTITY_DESC_SONY + VALID_SKU_SONY + IMAGE_DESC_SONY,
                expectedMessage);

        // missing inventory prefix
        assertParseFailure(parser, NAME_DESC_SONY + QUANTITY_DESC_SONY + SKU_DESC_SONY + VALID_IMAGE_SONY,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_SONY + VALID_QUANTITY_SONY + VALID_SKU_SONY + VALID_IMAGE_SONY,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, INVALID_NAME_DESC + QUANTITY_DESC_SONY + SKU_DESC_SONY + IMAGE_DESC_SONY
                + TAG_DESC_SMARTPHONE + TAG_DESC_GADGET, Name.MESSAGE_NAME_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, NAME_DESC_SONY + INVALID_QUANTITY_DESC + SKU_DESC_SONY + IMAGE_DESC_SONY
                + TAG_DESC_SMARTPHONE + TAG_DESC_GADGET, Quantity.MESSAGE_QUANTITY_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_SONY + QUANTITY_DESC_SONY + INVALID_SKU_DESC + IMAGE_DESC_SONY
                + TAG_DESC_SMARTPHONE + TAG_DESC_GADGET, Sku.MESSAGE_SKU_CONSTRAINTS);

        // invalid inventory
        assertParseFailure(parser, NAME_DESC_SONY + QUANTITY_DESC_SONY + SKU_DESC_SONY + INVALID_IMAGE_DESC
                + TAG_DESC_SMARTPHONE + TAG_DESC_GADGET, Image.MESSAGE_IMAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_SONY + QUANTITY_DESC_SONY + SKU_DESC_SONY + IMAGE_DESC_SONY
                + INVALID_TAG_DESC + VALID_TAG_GADGET, Tag.MESSAGE_TAG_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_NAME_DESC + QUANTITY_DESC_SONY + SKU_DESC_SONY + INVALID_IMAGE_DESC,
                Name.MESSAGE_NAME_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_SONY + QUANTITY_DESC_SONY + SKU_DESC_SONY
