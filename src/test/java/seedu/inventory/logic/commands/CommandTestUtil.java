...
public class CommandTestUtil {
    ...
    public static final String EMAIL_DESC_AMY = " " + PREFIX_SKU + VALID_EMAIL_AMY;
    public static final String EMAIL_DESC_BOB = " " + PREFIX_SKU + VALID_EMAIL_BOB;
    public static final String ADDRESS_DESC_AMY = " " + PREFIX_IMAGE + VALID_ADDRESS_AMY;
    public static final String ADDRESS_DESC_BOB = " " + PREFIX_IMAGE + VALID_ADDRESS_BOB;
    ...
    public static final String INVALID_EMAIL_DESC = " " + PREFIX_SKU + "bob!yahoo"; // missing '@' symbol
    public static final String INVALID_ADDRESS_DESC = " " + PREFIX_IMAGE; // empty string not allowed for addresses
