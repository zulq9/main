...
public class DeleteItemCommandSystemTest extends InventorySystemTest {
    ...
    /**
     * Deletes the item at {@code toDelete} by creating a default {@code DeleteItemCommand} using {@code toDelete} and
     * performs the same verification as {@code assertCommandSuccess(String, Model, String)}.
     * @see DeleteItemCommandSystemTest#assertCommandSuccess(String, Model, String)
     */
