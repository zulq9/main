...
public class FindItemSkuCommandSystemTest extends InventorySystemTest {
    ...
    @Test
    public void find() {
        /* Case: find multiple items in inventory using SKUs, command with leading spaces and trailing spaces
         * -> 2 items found
         */
        String command = "   " + FindItemSkuCommand.COMMAND_WORD + " " + KEYWORD_MATCHING_SAMSUNG + "   ";
        ...
        command = FindItemSkuCommand.COMMAND_WORD + " note s9";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find multiple items in inventory, 2 keywords with 1 repeat -> 2 items found */
        command = FindItemSkuCommand.COMMAND_WORD + " s9 Note s9";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
         ...
         * -> 2 items found
         */
        command = FindItemSkuCommand.COMMAND_WORD + " s9 Note NonMatchingKeyWord";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
        ...
        command = FindItemSkuCommand.COMMAND_WORD + " SamSung";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find item in inventory, keyword is substring of name -> 1 item found */
        command = FindItemSkuCommand.COMMAND_WORD + " Sam";
        ModelHelper.setFilteredList(expectedModel, SAMSUNG);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find item in inventory, name is substring of keyword -> 1 item found */
        command = FindItemSkuCommand.COMMAND_WORD + " Samsun";
        ModelHelper.setFilteredList(expectedModel, SAMSUNG);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find item not in inventory -> 0 items found */
        command = FindItemSkuCommand.COMMAND_WORD + " Windows";
        ModelHelper.setFilteredList(expectedModel);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find quantity of item in inventory -> 0 items found */
        command = FindItemSkuCommand.COMMAND_WORD + " " + LG.getQuantity().value;
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find image of item in inventory -> 0 items found */
        command = FindItemSkuCommand.COMMAND_WORD + " " + LG.getImage().value;
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find tags of item in inventory -> 0 items found */
        List<Tag> tags = new ArrayList<>(LG.getTags());
        command = FindItemSkuCommand.COMMAND_WORD + " " + tags.get(0).tagName;
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
        ...
        command = FindItemSkuCommand.COMMAND_WORD + " LG";
