...
for `export-csv-items` command below to illustrate how the `export` commands work.
...
Following lines are the details of the objects. Empty lines are not allowed. If a cell contains `,`, it must be surrounded
by `"` `"` .
