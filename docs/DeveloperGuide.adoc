...
to prevent any unidentified users to be able to access they application.

==== Implementation

===== Logic Component

Authentication usually works in the Logic Component of the system. This is due to this component has to be largely relied on
when the commands are executed. It has
