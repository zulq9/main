...
|`* * *` |manager |send email to users |send important information to staff
...
*** V1.2 Support exporting users and sales to email and excel
*** V1.3 Support exporting inventory to email and excel
