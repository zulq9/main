...
Staffs are stored in `XmlAdaptedStaff` objects, which maintain a class relationship as shown in this diagram.

.Staff objects are saved using XmlAdaptedStaff objects as shown above.
...
<staffs>
                ...
                <name>2018-12-12</name>
                <role>user</role>
</staffs>
----

Remark: Passwords are stored in hashed format using SHA-256 encoding.
