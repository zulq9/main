...
image::LoginSDForLogic.png[width=width]
...
image::AuthenticationModelComponentClassDiagram.png[width=width]
...
image::EditStaffSDForLogic.png[width=width]
...
image::StaffModelComponentClassDiagram.png[width=width]
...
image::StaffStorageComponentClassDiagram.png[width=width]
