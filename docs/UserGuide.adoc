...
|`Change Password` |`change-password p/NEW_PASSWORD` |`change-password p/newpassword`
...
|`Update User` |`edit-staff INDEX [n/NAME] [u/USERNAME] [p/PASSWORD] [r/ROLE]` |`edit-staff 2 n/Muhammad Zulqarnain u/zulq9 p/zulsenpai r/admin`
|`Remove User` |`delete-staff INDEX` |`delete-staff 3`
// Inventory Management
...
|`Add Purchase Order`| `add-po` | `add-po s/apple-iphone-xr q/1000 d/12-12-2018 sp/Apple Inc.`
|`Approve Purchase Order`|  `approve-po` | `approve-po 2`
|`Reject Purchase Order`|  `reject-po` | `reject-po 3`
|`Edit Purchase Order`|  `edit-po` | `edit-po 3 q/100`
|`Delete Purchase Order`|  `delete-po` | `delete-po 1`
// Report
