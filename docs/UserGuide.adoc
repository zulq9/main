...
image::doc-login.png[width={img-width}]
...
image::doc-change-password.png[width={img-width}]
...
image::doc-list-user.png[width={img-width}]
...
image::doc-delete-user-failed.png[width={img-width}]
...
The following commands are mainly used for you to manage the items stored in the inventory.
