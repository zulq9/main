...
The `find-item` command finds item whose names contain any of the given keywords.

image::doc-find-item.png[width="790"]
_Figure 4.6. The item searched for will be displayed on screen._
...
The `select` command selects the item identified by the index number used in the displayed inventory.
...
===== Export list of users to CSV: `export-csv-staff`

The `export-csv-staff` command export the list of users in CSV format to the filepath given.

Format: `export-csv-staff f/FILEPATH`
...
===== Import list of users from CSV: `import-csv-staff`

The `import-csv-staff` command imports the list of users in CSV format from the filepath given.

Format: `import-csv-staff f/FILEPATH`
...
|`Export List of Users to CSV` |`export-csv-staff f/FILEPATH` |`export-csv-staff f/C:/out/users.csv`
...
|`Import List of Users from CSV`  |`import-csv-staff f/FILEPATH` |`import-csv-staff f/C:/in/users.csv`
