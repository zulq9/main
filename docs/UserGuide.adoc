...
The `change-password` command updates an user information into the system with given new password.
...
==== Updating an user : `edit-staff`

The `edit-staff` command updates an user information into the system with given username.
